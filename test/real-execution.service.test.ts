    ...
    buildEntryDecision(
      ...
      if (marketSlice !== null && prediction !== null && openPosition === null) {
        executionDecision = {
          ...
          winningSetupType: "broad_continuation",
          winningEngineIds: ["breadth_engine", "local_momentum_engine", "local_microstructure_engine"],
          winningEngineComboKey: "breadth_engine+local_momentum_engine+local_microstructure_engine",
          winningEngineComboScore: 0.82,
          regimeId: "broad_up_strong",
          executionProfile: "broad_continuation",
          gateFailures: [],
...
function buildLivePredictionResponse(): PredictionResponse {
  return {
    ...
    crossAssetRegime: {
      ...
      hasStrongBreadth: true,
      hasLeaderLaggardOpportunity: false,
    },
    ...
    winningEngineComboKey: "breadth_engine+local_momentum_engine+local_microstructure_engine",
    winningEngineComboScore: 0.82,
    combinationReason: "global breadth leads continuation",
    comboBreakdown: {
      activeCombos: [],
      appliedBoostCombos: [],
